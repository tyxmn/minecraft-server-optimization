...
Для комфортной игры в 40 человек, вам понадобится 6 ГБ. Я рекомендую поставить этот сборщик мусора: `-XX:+UseSerialGC`. Он эффективно очищает лишний мусор из оперативной памяти. Рекомендую использовать весь процессор, если вы планируете создать мощный сервер для большого кол-ва игроков. Если в i9-9900KF 8 ядер - возьмите тариф из 8 ядер. Возможно, хост вам сделает скидку, если вы оплатите за довольно продолжительный период ( 12 и более месяцев ).
