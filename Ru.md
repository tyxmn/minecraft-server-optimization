...
У вас забивается оперативная память, а процессор грузится под 80+% при малой нагрузке? Вам нужно повышать мощности вашего сервера, ведь именно из-за нехватки кол-ва ядер или ГБ ОЗУ у вас могут возникать проблемы.
