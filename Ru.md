...
Для комфортной игры в 40 человек, вам понадобится 6 ГБ. Я рекомендую поставить этот сборщик мусора: `-XX:+UseSerialGC`. Он эффективно очищает лишний мусор из оперативной памяти.
